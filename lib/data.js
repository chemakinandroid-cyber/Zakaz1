...
export const styles = {
  ...
  button: { border: "none", borderRadius: 14, padding: "12px 16px", cursor: "pointer", fontWeight: 700 },
  ...
  badge: { display: "inline-block", padding: "4px 10px", borderRadius: 999, background: "#1f2937", color: "#eef2ff", fontSize: 13 },
  badgeDanger: { display: "inline-block", padding: "4px 10px", borderRadius: 999, background: "#450a0a", color: "#fecaca", fontSize: 13 },
  badgeWarn: { display: "inline-block", padding: "4px 10px", borderRadius: 999, background: "#78350f", color: "#fde68a", fontSize: 13 },
  badgeSuccess: { display: "inline-block", padding: "4px 10px", borderRadius: 999, background: "#052e16", color: "#86efac", fontSize: 13 },
  branchBtn: (active) => ({
    borderRadius: 20,
