...
import { branches, fmt, styles, MAX_ACTIVE_ORDERS, formatDateTime, STORAGE_KEYS, safeLoad, AUDIO_ENABLED_DEFAULT } from "@/lib/data";
...
export default function AdminPage() {
  ...
  const renderOrder = (o, activeSection) => (
    <div key={o.id} style={{ ...styles.cartItem, marginTop: 12 }}>
      ...
      <div style={{ marginTop: 8, color: "#94a3b8", fontSize: 14 }}>{formatDateTime(o.created_at)}</div>
      ...
      {o.note && <div style={{ marginTop: 8, color: "#94a3b8", fontSize: 13 }}>{o.note}</div>}
